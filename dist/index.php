...
<section class="ar__wrapper grid">
   ...
   <div class="grid__item one-half">
      ...
      <p>
        Former South African President Nelson Rolihlahla Mandela, who passed away on 5th December 2013, was an exemplary man who stood firmly for what was right. He stood up against corruption in any form, across every border. He called for the birth of a new morality.
      </p>
      <p>
      ...
      <p>
        Corruption Watch pays tribute to his life, his work and his memory. We will work tirelessly to foster his anti-corruption stance in our country.
      </p>
    </div>
...
<section class="ar__wrapper grid bkg-img bkg-img--1">
  ...
  <div class="grid__item one-third">
    ...
    <p>
      We ignore corruption at our own peril. It not only threatens economic stability and investment, but also damages critical public confidence in leadership. How can we move forward without trust in our leaders, whether they are in government, at the helm of a corporate or in charge of a school programme?
    </p>
  </div>
  <div class="grid__item one-third">
    <div class="icon__wrapper">
    ...
    <h4>
      Our country’s future is not for sale.
    </h4>
...
<section class="ar__wrapper grid">
  ...
  <p class="lead grid__item one-whole">
    Corruption Watch is a non-profit organisation that was launched in January 2012. We rely on the public to report corruption to us. We use the reports as an important source of information to fight corruption and hold leaders accountable for their actions.
  </p>

  <div class="text--center grid__item one-whole">
    <img src="img/magnifying-glass.svg"  alt="Communication - We provide a platform for reporting corruption. Anyone can safely share what they experience and observe and can speak out against corruption. Our communication platform includes our website, an SMS line, hotline (toll free when called from a landline), social media, email or post." />
  </div>
</section>

<section class="ar__wrapper grid bkg-img bkg-img--2 text--center">

  <div class="grid__item one-third">
   <div class="icon__wrapper">
      <img src="img/investigation.svg" alt="" />
    </div>
    <h4>
      Investigation
    </h4>
  ...
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="img/mobilisation.svg" alt="" />
    </div>
    <h4>
      Mobilisation
    </h4>
...
<section class="ar__wrapper grid">
 ...
 <img src="img/microphone.svg" alt="" class="grid__item one-third" />

 <div class="grid__item two-thirds">
   <h3>
     In a corrupt society, everything can be ‘bought’, but this comes with a hidden cost. In the fight against corruption, every voice, every person who speaks up makes a difference.
   </h3>

   <p><strong>Report corruption concerns in any of these ways:</strong></p>
   <ul>
      <li>Call our hotline 0800 023 456, which is toll free when called from a landline</li>
      <li>Fill in <a href="http://www.corruptionwatch.org.za/content/make-your-complaint" target="_blank">our online form</a></li>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-whole">
    ...
    <ul>
      <li>A business or person pays a bribe to a government official to be given a government contract or licence. </li>
      <li>Use of government-owned resources such as motor vehicles for private needs. </li>
      <li>Nepotism in awarding public contracts i.e. a government official taking advantage of his/her position to favour a family member or business associate for a job or tender contract.</li>
      <li>Soliciting of a bribe by a police officer or government employee to enable a member of the public to sidestep the consequences of unlawful conduct.</li>
    </ul>
</section>
...
<section class="ar__wrapper--white grid">
  ...
  <div class="grid__item one-half">
    ...
    <p><strong>Abuse of power by a public official –</strong> the improper use of authority by someone who holds a position in public office</p>

    <p><strong>Abuse of government resources by a public official –</strong> the misuse of state funds, personnel, bodies, regulations, and law enforcement by a public official for private gain</p>

    <p><strong>Accountability –</strong> ensuring that officials in the public and private sectors are answerable for their actions and that there are consequences when duties and commitments are not met</p>

    <p><strong>Bribery –</strong> an offer of money, goods or services in order to gain an advantage </p>
  </div>

  <div class="grid__item one-half">

    <p><strong>Fraud –</strong> the deceit, manipulation or distortion of information by a public officer with the intention to seek personal gain</p>

    <p><strong>Nepotism –</strong> a form of corruption in employment which involves the favouring of friends and family when granting jobs or benefits</p>

    <p><strong>Public procurement –</strong> the buying of goods and services by government departments</p>

    <p><strong>Transparency –</strong> a principle in which public officials and individuals in the private sector have a duty to act in a responsible and visible manner to promote accountability</p>
  </div>
</section>

<!--       ====================       -->
<!-- End Corruption fighters speak up -->
<!--       ====================       -->
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-half">
    <img src="img/corruption_exposed.svg" alt="Corruption confirmed in 58% of reports received" />
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item six-tenths">
    ...
    <p>
      Every person speaking up against illegal practices such as following incorrect tender processes, a lack of due diligence in deal making, bribery and misuse of funding, helps us tackle corruption.
    </p>
  </div>
  ...
  <div class="grid__item three-tenths">
    <img src="img/calendar.svg" alt="6 reports received a day" />
  </div>
</section>
...
<section class="ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    <h5 class="seperate">
      Corruption reporting on the up, qualitatively and quantitatively
    </h5>

    <img src="img/arrows.svg" alt="" class="center" />
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item two-fifths">
    <p class="lead">With 38% of corruption allegations reported in 2013 coming from Gauteng, it topped the provincial scales. 14% of the reports focused on allegations of corruption in the Free State vs. its 7% the prior year. The Eastern Cape and Kwa-Zulu Natal (KZN) featured side by side, with 13% of corruption allegations respectively in 2013.</p>
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-whole">
    ...
    <h2>
      Corruption fighters across South Africa are speaking up!
    </h2>
  </div>

  <div class="grid__item two-thirds">
    <img src="img/corruption_chanels.svg" alt="" />
  </div>

  <div class="grid__item one-third">
    <div class="Xlight">
      <p>
        The introduction of Corruption Watch’s hotline (0800 023 456) in September 2013 accounted for 9% of the total reports received
      </p>
    </div>
    <div class="Xlight">
      <p>
        As was the case in 2012, online reporting through <a href="http//www.corruptionwatch.org.za" target="_blank">www.corruptionwatch.org.za</a> provided corruption fighters with an effective channel through which to file concerns about corruption
      </p>
    </div>
    <div class="Xlight">
      <p>
        The widely accessible channel of SMS was the second most widely used way in which corruption fighters reported allegations
      </p>
    </div>
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-whole text--center">
    <img src="img/raising_red_flags.svg" alt="" />
  </div>

  <div class="text--center  primary">
    <p class="lead grid__item two-thirds">
      Abuse of government resources by a public official ranked as the most prevalent type of corruption, up by 9% compared to Corruption Watch’s 2012 data. Corruption in procurement processes was found in 15% of the cases and bribery in 13%, while corruption in employment took place in 9% of cases.
    </p>
  </div>
  <p>&nbsp;</p>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-whole">
    ...
    <p class="lead">The school bell rings, reminding learners to focus on their studies and to take another step forward towards a positive future. Worryingly, this year we uncovered mass evidence of corruption in schools and as a result, the melodious school bell has escalated to be a bellowing siren. </p>
  </div>

  <div class="grid__item one-half text--center">
    <img src="img/schools_piechart.svg" alt="" />
  </div>
  <div class="grid__item one-half">
    <div class="Xlight">
      <p>
        More than half of respondents to our Mxit survey believed that corruption in schools is on the rise.
      </p>
    </div>
    <div class="Xlight">
      <p>
        Selling of test and exam papers is a particular problem in Mpumalanga. Misuse of school money or property was prevalent in the Free State and the North West provinces.
      </p>
    </div>
  </div>
  ...
  <div class="grid__item one-half">
    <p>
      Since our inception in 2012, 661 (12%) of the total number of reports received by Corruption Watch related to allegations of corruption in the schooling environment. After investigation, a substantial 554 (85%) of these reports were confirmed as being cases of corruption.
    </p>
    <p>
      Reports indicated that principals, School Governing Body (SGB) members and to an extent, teachers, were manipulating and abusing the school system and processes to enrich themselves. Concerns reported ranged from abuse of public funds received for infrastructure maintenance and upgrading to sourcing of learning materials, funding of feeding schemes and more.
    </p>
    <p>
      Delving into the matter, Corruption Watch conducted a survey via Mxit, sampling 3 284 respondents. More than half of this sample, between the ages 13 and 34 years old, believed that corruption in schools is on the rise. Almost half of the respondents were learners at school or at a FET college, while 31% were family members of a school learner. Most learners (30%) were from public schools and just 8% were in private schools.
    </p>
    <p>
  ...
  <div class="grid__item one-half">
    <p>
       It also found that the selling of test and exam papers was a particular problem in Mpumalanga (23%), while the misuse of school money or property was especially prevalent in the Free State (30%) and the North West provinces (31%).
    </p>
    <p>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-whole text--center">
    ...
    <img src="img/schools_for_sale.svg" alt="" />
  ...
  <div class="grid__item one-quarter">
    <img src="img/school_corruption--icons-01.svg" alt="" />
    <p>
      Principals are the main wrongdoers and often pay for projects that don’t materialise.
    </p>
  </div>

  <div class="grid__item one-quarter">
    <img src="img/school_corruption--icons-02.svg" alt="" />
    <p>
  ...
  <div class="grid__item one-quarter">
    <img src="img/school_corruption--icons-03.svg" alt="" />
    <p>
      School Governing Bodies do not make financial statements available to parents, either because they do not exist or because the Body refuses to provide this information.
    </p>
  </div>

  <div class="grid__item one-quarter">
    <img src="img/school_corruption--icons-04.svg" alt="" />
    <p>
      Teachers draw salaries when they are repeatedly absent from work without explanation and are sometimes engaged in full-time remunerative work outside of the school without permission from relevant authorities.
    </p>
  </div>
</section>
...
<section class="ar__wrapper--white grid">
  ...
  <div class="grid__item two-thirds">
    ...
    <p class="lead">
      Financial mismanagement, theft of goods and corruption in procurement were the top types of corruption reported in 2013.
    </p>
  </div>
  <div class="grid__item one-third text--center">
    <img src="img/school_hotspots.svg" alt="" />
  </div>

  <div class="grid__item one-whole bkg-img bkg-img--3 text--center">
    <img src="img/school_hotspots--graph.svg" alt="" />
    <p></p>
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <p class="lead">
    This is what Sibongile Mtuki, the Deputy Principal of Thubelihle Intermediate School, who was part of a group of teachers who blew the whistle on the corruption, had to say:
  </p>

  <blockquote class="grid__item three-quarters">
    <p>
      What raised our suspicions was the fact that the same person [Ngwenya] was elected repeatedly as chairperson of the SGB. There is protocol that must be followed when choosing members of the SGB and the principal. All parents of learners are eligible for election as a member of the SGB.
    </p>
    <p>
      We decided at the last election that we did not want him [Ngwenya] back because he did not qualify to be a member of the SGB. We needed a new person with ideas and innovative thinking for the benefit of the school. Unfortunately though, he was elected once again even though he did not qualify.
    </p>
    <p>
    ...
    <p>
      There has been no honesty with regards to the running of the school and that looks bad in the eyes of the community. We don’t have confidence in you [Usiba]. We don’t need you.
    </p>
    <footer><cite>
     Sibongile Mtuki
    </cite></footer>
...
<section class="ar__wrapper grid">
  <h2 class="grid__item one-whole">
    Finding financial deceipt at Thubelihle
  </h2>

  <div class="grid__item one-half">
    <p>
      In February 2013, Corruption Watch received a complaint from a group of teachers at Thubelihle Intermediate School in White City, Soweto. It was alleged that the principal, Nonzwakazi Usiba and former chairperson of the School Governing Body (SGB), Isaac Ngwenya, were tangled in corrupt activities. It was suspected that Usiba and Ngwenya were involved in the misuse of school funds.
    </p>
    <p>
      After investigation, Corruption Watch found mass evidence of fraud in the school’s finances. We commissioned an independent auditing firm to assess our findings. The auditors confirmed that corruption was evident and that Usiba and Ngwenya were directly implicated in the wrongdoings, which included:
    </p>


    <ul>
      <li>
        41 school cheques totalling R134 487.56, made out and cashed by Usiba. Some of the cheques stated “feeding for learners” but no corresponding invoices were found.
      </li>
      <li>
        10 school cheques totalling R41 059.30 were made out to Ngwenya and no invoices corresponded with the payment.
      </li>
    </ul>
  </div>
  <div class="grid__item one-half">
...
<section class="ar__wrapper--white grid">
  ...
  <div class="grid__item one-half">
    <h5>Accountable School Governing Body Member and parent</h5>
    <p>
      “The SGB chairperson at *** School is abusing his chairpersonship to loot school funds. His name is Mr T*** and he also claims to be a lawyer. My concern is that he crooked the SGB board to give him R12 000 for a court case that never took place. He claims to have represented the school at an out of court settlement meeting with a security company that used to guard our school. As a parent and a SGB member of the school, I request Corruption Watch to stop this person.”
    </p>
  </div>

  <div class="grid__item one-half">
    <h5>Concerned anti-corruption parent</h5>
    <p>“I am a parent of *** Primary in KwaZulu-Natal and I am writing this letter regarding our former principal Mr ***. Last year the governing body charged him with allegations of fraud, corruption and also serious mismanagement of school funds. He used the funds for a holiday in Cape Town. The Department of Education investigated the matter and found that there was enough merit to suspend him immediately. During his period of suspension the ******** offered him a post as their Deputy for Education and Training. The former principal seized the opportunity and resigned. This is unacceptable to me as a parent. A person who has been charged with fraud, corruption and serious mismanagement of school funds is now free.”</p>
  </div>

  <div class="grid__item one-half">
    <h5>‘Sad parent’ making a difference</h5>
...
<section class="ar__wrapper grid">
  ...
  <div class="grid__item one-half">
    ...
    <div class="text--center">
      <img src="img/megaphone--red.svg" alt="" class="three-quarters" />
    </div>
  </div>
  <div class="grid__item one-half">
    <h2>
      Behind the scenes of breaking the silence
    </h2>
    <p>
      In 2012, Corruption Watch received reports that rural development NGO, Mvula Trust had obtained a government tender worth R30-million, irregularly. A four-month investigation began and in early 2013, we exposed Mvula Trust for fronting by subcontracting a significant part of the contract to a third party, Ubuntu Sima.
    </p>
    <p>
      The tender formed part of a job creation initiative for the Department of Co-operative Governance and Traditional Affairs (COGTA), called the Community Work Programme (CWP).
    </p>
    <p>
      Following a number of allegations of illegality and complaints about the CWP, as well as pressure from Corruption Watch, COGTA instituted an independent, comprehensive inquiry to look into these allegations, including the award of a contract to Mvula Trust.
    </p>
    <p>
      In May 2013, Corruption Watch made submissions to the inquiry based on the findings of our investigation. We had found that the arrangement between the Mvula Trust and the third party was not disclosed in the initial bidding documents as required. To boot, a number of questionable links relating to conflicts of interest between the Trust and Ubuntu Sima were uncovered.
    </p>
    <p>
      We continue to pursue this issue and will advocate that there are consequences for those who attempt to corrupt the CWP.
    </p>
  </div>
  ...
  <div class="grid__item one-half">
    ...
    <p>
      In October 2012, the accounting officer for Seletech, that had supplied special glass vials in which drinking water was tested for over a year, received a strange email that included an official purchasing order invoice per set of 12 vials, valued at R24 000. Due to his own company supplying the same equipment for some time to the municipality for only R2 000 per set, he realised that something was not right.
    </p>
  </div>
  <div class="grid__item one-half">
    <p>
    ...
    <p>
      On investigation into the unbalanced invoicing equation, Corruption Watch discovered that the procurement officer at the municipality who signed off on the   R24 000 payment to Sinqobile &amp; Jose was Rabelani Thukwana – who was married to Sipho Thukwana.happens to be the same person to whom Seletech was asked to deliver the set of vials last year and to whom Sinqobile &amp; Jose is registered.
    </p>
    <p>
  ...
  <div class="grid__item one-half">
    ...
    <h3>
      Unfit circumcision tender process diagnosed
    </h3>

    <p>
      In August 2013, following a corruption fighter’s complaint, Corruption Watch began investigating the Mpumalanga Health Department’s choice to award a multi-million rand tender to circumcise 260 000 boys and men in the province. Earlier in 2013, the department signed a one year-contract with Ebby Bongani Mkhabela, the owner of Mkhago Health Care Services to perform circumcisions at a cost of R700 per person, without advertising the contract.
    </p>
  </div>
  <div class="grid__item one-half">
    <p>
      The bottom line of this case was that if all 260 000 circumcisions were completed,  Mkhago Healthcare Service would have been R182-million richer. Our investigation revealed that the public tender process was not followed in the awarding of the contract. By law all contracts over R500 000 must be awarded through a public competitive bidding process.
    </p>
    <p>
      In the case of Mkhago, Corruption Watch found that the company presented a business proposal and won the contract without having to go through the required tender process. The investigation also revealed that Mkhabela has been linked to a botched circumcision in 2008!
    </p>
    <p>
      Based on our findings, the Department of Health set out to conduct its own forensic investigation into the matter and in the meantime, the contract between the department and Mkhago is suspended.
    </p>
  </div>
  ...
  <div class="grid__item one-half">
    ...
    <p>
      Corruption Watch continued to make a valuable contribution to the fight against corruption during 2012/13, as is shown in our participation in a Constitutional Court case involving Allpay Consolidated Investment Holdings (Allpay) and others v The South African Social Security Agency (SASSA) and others.
    </p>
    <p>
      Due to our focus on encouraging vigilance in public procurement, Corruption Watch appeared in the Constitutional Court in a case in which the awarding of a R10-billion tender by SASSA to a private company, Cash Paymaster Services (CPS) for the distribution of social grants was being disputed.
    </p>
    <p>
      In the region of 15 million people in South Africa depend on social grants, and for many this is their sole income. SASSA is responsible for the distribution of grants, subcontracting the distribution to a number of payment system firms. Where previously the subcontracts were entered in a provincial context, the R10 billion tender was given to CPS for the whole country.
    </p>
    <p>
  ...
  <div class="grid__item one-half">
    ...
    <p>
      ...
      <ol>
        <li>To ensure fairness to participants in the bid process</li>
        <li>To enhance the likelihood of efficiency and optimality in the outcome</li>
        <li>To serve as a guardian against a process skewed by corrupt influences</li>
      </ol>
    </p>
    <p>
      The Court found that SASSA had failed to investigate and confirm CPS’s Black Economic Empowerment credentials before awarding the business. It also found that the second bidders’ notice issued during the tender process was vague and uncertain, and gave rise to procedural unfairness.
    </p>
    <p>
      <!-- Though despite the fact that the Court declared the award of the tender to CPS invalid, it remains in place for the time being. --> The Court has ordered the parties to return to court on 11 February 2014 to present evidence as to a “just and equitable” remedy.
    </p>
  </div>
  ...
  <div class="grid__item one-half">
    ...
    <ol>
      <li>Prohibiting public officials from conducting business with the State. In our view, a ban on public officials doing business with the State should be extended to include a ban on immediate family members of public officials doing the same.</li>
      <li>Restriction of outside remunerative work.</li>
      <li>Prohibiting the re-employment of individuals if they are dismissed for misconduct.</li>
      <li>The introduction of a ‘cooling-off’ period before a public official can enter the private sector from the public sector.</li>
    </ol>
  </div>
</section>
...
<section class="ar__wrapper--white grid">
  ...
  <div class="grid__item two-thirds">
    ...
    <p>
      The submission to the Competition Tribunal related to the hearings into the R1.46-billion settlement agreements facing top listed construction firms who rigged bids for, among other large projects, the FIFA 2010 World Cup™ infrastructure projects.
    </p>
    <h5>
      In the written submission, Corruption Watch:
    </h5>
    <ol>
      <li>Commended the Competition Commission for securing consent agreements with the 15 implicated companies and recommended that the Competition Tribunal confirm the settlements.</li>
      <li>Urged the Competition Commission to make provision for future ‘naming and shaming’ of individual perpetrators.</li>
      <li>Advised that the Competition Commission take swift action against those companies in the cartel who have not settled claims.</li>
      <li>Called on companies who agreed to the settlement to recover bonuses awarded to individuals named in the cartel.</li>
      <li>Called for a comprehensive and integrated approach to fighting corruption, which demands the involvement of multiple stakeholders, most importantly an engaged and active citizenry.</li>
      <li>Encouraged parties damaged by the cartel to file civil claims against the companies involved.</li>
    </ol>
  </div>
  ...
  <div class="grid__item one-third Xlight">
    ...
    <h5>
      Here’s how to determine whether you should report a concern that could be a conflict of interest.
    </h5>

    <p>
      A conflict of interest is any financial or other private interest or undertaking that could directly or indirectly compromise the performance of the public servant’s duties or the reputation of a public servant’s department in its relationship with its stakeholders.
    </p>

    <p>
      For example:
      <ul>
        <li>Holding public office as well as private business interests and using your public position to benefit your private interests.</li>
        <li>Influencing government tender processes so that your family members and friends are awarded State contracts.</li>
        <li>Abusing your position in a government department to ensure your friends and family are hired in the same department.</li>
        <li>Tendering for a municipal contract when you are an employee of the municipality.</li>
      </ul>
    </p>
    <p>
...
<section class="ar__wrapper grid">
  <div class="grid__item one-whole">
    <h1 class="highlight">
      The need to take our country forward holding our heads high
    </h1>
  ...
  <div class="grid__item one-half">
    ...
    <img src="img/megaphone--white.svg" alt="" class="one-quarter float--left" />
    ...
    <img src="img/school_corruption--icons-01.svg" alt="" class="one-third float--left" />

    <p>
      The Department of Public Service and Administration has published a Bill which, if successfully implemented, will go a long way towards stemming corruption in the public sector. It is beginning to dawn on elected representatives that if they continue to participate in or to ignore corruption they risk losing the last remnants of trust that you, the electorate, have in them.
    </p>
    <p>
      But very troubling dark spots remain. For people who travel the roads and streets of South Africa, traffic policing can mean corruption.  For traders, corrupt municipal police may well be your everyday experience.
    </p>
  ...
  <div class="grid__item one-half">
    ...
    <img src="img/school_corruption--icons-04_alt.svg" alt="" class="one-quarter float--left" />
    ...
    <img src="img/investigation_alt.svg" alt="" class="one-sixth float--left" />
    ...
    <p>
      Up until now we have concentrated on the conduct of public officials and the private.  It is time to turn our attention to our elected representatives, those who are meant to represent an accountable democracy.
    </p>
  </div>
</section>
...
<section class="ar__wrapper--white grid">
  ...
  <div class="grid__item one-whole text--center">
    ...
    <p class="lead">
      There is a growing movement of people in South Africa who are concerned about potential corruption in their community. This force of corruption fighters is growing as more and more, people step forward, speak up and speak out.
    </p>
    <img src="img/corruption_fighter.svg" alt="Corruption Fighter" />
  </div>
</section>
...
<section class="ar__wrapper grid">
  ...
  <hr />
    ...
    <p>
      Alice Brown is an international human rights advocate and an expert on the use of the law for the public good Her distinguished career has focused on civil rights litigation and social justice philanthropy, with an emphasis on institution-building for non-governmental organisations.
    </p>
    <p>
    ...
    <p>
      Currently she is called upon to advise and speak on a broad range of topics including philanthropic giving, good governance, leadership development, organisational effectiveness and public interest law.
    </p>
  ...
  <hr />
    ...
    <p>
      Vuyiseka Dubula, the general secretary of the Treatment Action Campaign (TAC), has been a role model for women living with HIV since she joined the organisation in 2002 as a literacy co-ordinator.
    </p>
    <p>
      She later became provincial co-ordinator for the Western Cape and then national co-ordinator before taking up the duties of general secretary in 2008.
    </p>
    <p>
      Dubula has been chairperson of the board of the Aids Law Project since 2008 and is currently a board member of gender rights organisation Sonke Gender Justice. She is the former chairperson of the board of Corruption Watch.
    </p>
    <p>
  ...
  <hr />
    ...
    <p>
      He is presently on suspension as the general secretary of Cosatu, an organisation to which he has devoted three decades of service.
    </p>
  </div>
</section>
