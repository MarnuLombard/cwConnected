...
<div class="section ar__wrapper grid">
  ...
  <div class="ar__nav grid__item two-fifths">
    <span class="nav-link__wrapper">
      ...
      Corruption Fighters Speak Up</a>
        ...
        Your Voice Counts</a>
        <a href="#section--what_is_corruption" class="nav-link--sub">
        What is Corruption?</a>
        <a href="#section--corruption_talk" class="nav-link--sub">
        Corruption Talk</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--on_our_watch" class="nav-link">
      On Our Watch</a>
        <a href="#section--corruption_reported" class="nav-link--sub">
        Corruption Reported</a>
        <a href="#section--provincial_corruption_concerns" class="nav-link--sub">
        Provincial Corruption Concerns</a>
        <a href="#section--corruption_in_government" class="nav-link--sub">
        Corruption in Government</a>
        <a href="#section--corruption_fighting_channels" class="nav-link--sub">
        Corruption Fighting Channels</a>
        <a href="#section--corruption_investigated" class="nav-link--sub">
        Corruption Investigated</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--schools" class="nav-link">
      Schools</a>
        <a href="#section--sounding_the_siren" class="nav-link--sub">
        Sounding The Siren On Corruption In Schools</a>
      <a href="#section--falling_on_deaf_ears" class="nav-link--sub">
    ...
    <span class="nav-link__wrapper">
      <a href="#section--government_ngos" class="nav-link">
      Government and NGOs</a>
        <a href="#section--mvula_trust_scandal" class="nav-link--sub">
        Exposed! Mvula Trust Scandal</a>
        <a href="#section--construction_cartel" class="nav-link--sub">
        Furthering Legal Action Against The Construction Cartel</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--leading_perspective" class="nav-link">
      Leading Perspective</a>
        <a href="#section--corruption_fighter" class="nav-link--sub">
        Profile of a Corruption Fighter</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--leadership_profile" class="nav-link">
      Leadership Profile</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--funders" class="nav-link">
      Funders and Supporters</a>
    </span>
    <span class="nav-link__wrapper">
  ...
  <div class="grid__item three-fifths">
    ...
    <p>&nbsp;</p>
    <blockquote class="three-fifths center">
...
<div class="section ar__wrapper grid">
  <div class="grid__item two-thirds">
    <h2>
      ...
      <small>1918 - 2013</small>
    </h2>
    <p>
      Former South African President Nelson Rolihlahla Mandela, who passed away on 5th December 2013, was an exemplary man who stood firmly for what was right. He stood up against corruption in any form, across every border. He called for the birth of a new morality.      </p>
    <p>
      His resolute approach to rooting out corruption is captured in his 1996 State of the Nation Address in which he said, "Dealing with crime, violence and corruption requires a new morality for our new nation. Indeed, it requires a new patriotism among communities, the public and private sectors, and the security services - so that at the end of each day, each one of us can answer in the affirmative the question: have I done something today, to stamp out crime!"      </p>
    <p>
      Corruption Watch pays tribute to his life, his work and his memory. We will work tirelessly to foster his anti-corruption stance in our country.      </p>
  </div>

  <div class="grid__item one-third text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/mandela.jpg" alt="Nelson Mandela" class="three-quarters" />
  </div>
</div>
...
<div class="section ar__wrapper grid bkg-img bkg-img--1">
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/megaphone.png" alt="" />
    </div>
    <h4>
      Speak up against corruption.
    </h4>
    <p>
      People across the country are speaking out against corruption in their communities. Every one of these <a href="#section--corruption-fighter">
      corruption fighters is making a difference</a> and they do this by speaking up when they are confronted with dishonest dealings, public mismanagement of funds and general abuse of power. As a collective, if we are going to rip off the price tag on South Africa, we all need to become corruption fighters
    </p>
  </div>
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/tag.png" alt="" />
    </div>
    <h4>
      Rip off the price tag.    </h4>
    <p>
      We ignore corruption at our own peril. It not only threatens economic stability and investment, but also damages critical public confidence in leadership. How can we move forward without trust in our leaders, whether they are in government, at the helm of a corporate or in charge of a school programme?    </p>
  </div>
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/cash.png" alt="" />
    </div>
    <h4>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole" id="section--what_is_corruption_watch">
    What is Corruption Watch?  </h1>
  ...
  <div class="text--center grid__item one-whole">
    <img src="/themes/corruption-watch/color-schemes/grey/img/magnifying-glass.png"  alt="Communication - We provide a platform for reporting corruption. Anyone can safely share what they experience and observe and can speak out against corruption. Our communication platform includes our website, an SMS line, hotline (toll free when called from a landline), social media, email or post." />
  </div>
</div>

<div class="section ar__wrapper grid bkg-img bkg-img--2 text--center">
  <div class="grid__item one-third">
   <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/investigation.png" alt="" />
    </div>
    <h4>
      Investigation    </h4>
    <p>
      We investigate selected reports of alleged acts of corruption, choosing cases that have the most serious impact on society. We hand over our findings to the authorities to take further action and we monitor the progress of each case. We work with mainstream and community media to make sure that corruption is fully exposed.    </p>
  </div>
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/research.png" alt="" />
    </div>
    <h4>
      Research    </h4>
    <p>
      We gather and analyse information to identify patterns and hot spots of corruption. We prepare research reports on these hot spots to expose and find solutions to systemic corruption. Using our communication platforms and the media, we share our findings with the public, like-minded non-governmental organisations and public sector bodies undermined by corruption.    </p>
  </div>
  <div class="grid__item one-third">
    <div class="icon__wrapper">
      <img src="/themes/corruption-watch/color-schemes/grey/img/mobilisation.png" alt="" />
    </div>
    <h4>
      Mobilisation    </h4>
    <p>
      We build campaigns that mobilise people to take a stand against corruption. Our campaigns involve the public, community groups and other organisations such as trade unions.    </p>
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole text--center" id="section--your_voice_counts">
    Your voice counts  </h1>
 <img src="/themes/corruption-watch/color-schemes/grey/img/microphone.png" alt="" class="grid__item one-third" />
 <div class="grid__item two-thirds">
   <h3>
  ...
  <ul>
    <li>
    Call our hotline 0800 023 456, which is toll free when called from a landline</li>
    <li>
    Fill in <a href="http://www.corruptionwatch.org.za/content/make-your-complaint" target="_blank">
    our online form</a>
    </li>
    <li>
    Send an SMS with the word <strong>
    BRIBE to 45142</strong>
    (R1 per SMS)</li>
    <li>
    Email us at <a href="mailto:info@corruptionwatch.org.za">
    info@corruptionwatch.org.za</a>
    </li>
    <li>
    Send us a letter, posting it to PO Box 113, Parklands, 2121</li>
  </ul>
  </div>
</div>
...
<div class="section ar__wrapper grid ar__wrapper--blockquote">
  <blockquote class="grid__item one-half">
    ...
    <cite>
      ...
      Archbishop Njongo Ndungane</a>
    </cite>
    </footer>
  </blockquote>
  <figure class="grid__item one-half">
    <img src="/themes/corruption-watch/color-schemes/grey/img/archbishop.jpg" alt="Archbishop Njongo Ndungane" />
  </figure>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole text--center" id="section--what_is_corruption">
    What is corruption?  </h1>
  <h4 class="grid__item one-whole seperate">
    Corruption is the abuse of public resources to enrich or give unfair advantage to individuals, their family or their friends. Corruption Watch is concerned with any such abuse of power or position by anyone at any level of government or in business.  </h4>
</div>
...
<div class="section ar__wrapper grid ar__wrapper--blockquote">
  ...
  <figure class="grid__item one-half">
    <img src="/themes/corruption-watch/color-schemes/grey/img/david.jpg" alt="David Lewis" />
  </figure>
</div>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    ...
    <ul>
      ...
      <li>
      Use of government-owned resources such as motor vehicles for private needs. </li>
      <li>
      Nepotism in awarding public contracts i.e. a government official taking advantage of his/her position to favour a family member or business associate for a job or tender contract.</li>
      <li>
...
<div class="section ar__wrapper--white grid">
  <h1 class="grid__item one-whole text--center"  id="section--corruption_talk">
    Corruption talk  </h1>
  <h3 class="grid__item one-whole">
    Terms that crop up in the fight against corruption  </h3>
  <div class="grid__item one-half">
    ...
    <p>
      <strong>Accountability –</strong> ensuring that officials in the public and private sectors are answerable for their actions and that there are consequences when duties and commitments are not met</p>
    <p>
  ...
  <div class="grid__item one-half">
    ...
    <p>
      <strong>Nepotism –</strong> a form of corruption in employment which involves the favouring of friends and family when granting jobs or benefits</p>
    <p>
      <strong>Public procurement –</strong> the buying of goods and services by government departments</p>
    <p>
      <strong>Transparency –</strong> a principle in which public officials and individuals in the private sector have a duty to act in a responsible and visible manner to promote accountability</p>
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--on_our_watch">
    On our watch
  </h1>
</div>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    ...
    <h2>
    Ripping off South Africa’s price tag!</h2>
    <h3>
      Corruption confirmed in <span class="highlight">58%</span> of reports received
    </h3>
  </div>
  <div class="grid__item one-half">
    <img src="/themes/corruption-watch/color-schemes/grey/img/corruption_exposed.png" alt="Corruption confirmed in 58% of reports received" />
  </div>
</div>

<div class="section ar__wrapper grid">
  <a href="#top" class="link--toTop">Back to top</a>
  <div class="grid__item six-tenths" id="section--corruption_reported">
    <h1 class="highlight">
      Corruption reported
    </h1>
    <p>
      Every person speaking up against illegal practices such as following incorrect tender processes, a lack of due diligence in deal making, bribery and misuse of funding, helps us tackle corruption.    </p>
  </div>
  <div class="grid__item one-tenth">
    <p>&nbsp;</p>
  </div>
  <div class="grid__item three-tenths">
    <img src="/themes/corruption-watch/color-schemes/grey/img/calendar.png" alt="6 reports received a day" />
  </div>
</div>
...
<div class="section ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    <h5 class="seperate">
      Corruption reporting on the up, qualitatively and quantitatively    </h5>
    <img src="/themes/corruption-watch/color-schemes/grey/img/arrows.png" alt="" class="center" />
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole" id="section--provincial_corruption_concerns">
    Provincial corruption concerns
  </h1>

  <div class="grid__item three-fifths">
    <img src="/themes/corruption-watch/color-schemes/grey/img/map.png" alt="" />
 <br />
    <em>
  ...
  <div class="grid__item two-fifths">
    <p class="lead">
    With 38% of corruption allegations reported in 2013 coming from Gauteng, it topped the provincial scales. 14% of the reports focused on allegations of corruption in the Free State vs. its 7% the prior year. The Eastern Cape and Kwa-Zulu Natal (KZN) featured side by side, with 13% of corruption allegations respectively in 2013.</p>
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-whole">
    <h1 id="section--corruption_in_government">
      Corruption in Government    </h1>
    <div class="text--center">
      <img src="/themes/corruption-watch/color-schemes/grey/img/government_graph.png" alt="" class="center" /> <br />
      <p>
        <em>*"Other" includes corruption within municipal owned entities, NGOs and charities, unions, or unknown.</em>
      </p>
    </div>
    <p>
      In 2012, reports of corruption concerns submitted to Corruption Watch lay evenly between local and provincial government sectors, accounting for roughly 33% each of the total number of reports received from the public. The 2013 reporting landscape featured a significant dip in alleged corruption in local government, while a dominant  48% of corruption allegations featured in the provincial tier. Another note of caution lies in the significant 16% of corruption allegations reported that point to national government.    </p>
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-whole">
    <h1 id="section--corruption_fighting_channels">
      Corruption fighting channels    </h1>
    <h2>
      Corruption fighters across South Africa are speaking up!    </h2>
  </div>
  <div class="grid__item two-thirds">
    <img src="/themes/corruption-watch/color-schemes/grey/img/corruption_chanels.png" alt="" />
  </div>
  <div class="grid__item one-third">
    <div class="Xlight">
      <p>
        The introduction of Corruption Watch’s hotline (0800 023 456) in September 2013 accounted for 9% of the total reports received      </p>
    </div>
    <div class="Xlight">
      <p>
        As was the case in 2012, online reporting through <a href="http//www.corruptionwatch.org.za" target="_blank">
        www.corruptionwatch.org.za</a> provided corruption fighters with an effective channel through which to file concerns about corruption      </p>
    </div>
    <div class="Xlight">
      <p>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole" id="section--corruption_investigated">
    Corruption investigated  </h1>
  <h2 class="grid__item one-whole">
    Raising red flags  </h2>
  <div class="grid__item one-whole text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/raising_red_flags.png" alt="" />
  </div>
  <div class="text--center  primary">
    <p class="lead grid__item two-thirds">
      Abuse of government resources by a public official ranked as the most prevalent type of corruption, up by 9% compared to Corruption Watch’s 2012 data. Corruption in procurement processes was found in 15% of the cases and bribery in 13%, while corruption in employment took place in 9% of cases.    </p>
  </div>
  <p>&nbsp;</p>
  <div class="grid__item one-whole text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/government_graph--2.png" alt="" />
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--schools">
    Schools  </h1>
    </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    <h1 class="highlight" id="section--sounding_the_siren">
      Sounding the siren on corruption in schools    </h1>
    <h2>
      Claiming back our childrens’ future    </h2>
    <p class="lead">
    The school bell rings, reminding learners to focus on their studies and to take another step forward towards a positive future. Worryingly, this year we uncovered mass evidence of corruption in schools and as a result, the melodious school bell has escalated to be a bellowing siren. </p>
  </div>
  <div class="grid__item one-half text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/schools_piechart.png" alt="" />
  </div>
  <div class="grid__item one-half">
    <div class="Xlight">
      <p>
        More than half of respondents to our Mxit survey believed that corruption in schools is on the rise.      </p>
    </div>
    <div class="Xlight">
      <p>
        Selling of test and exam papers is a particular problem in Mpumalanga. Misuse of school money or property was prevalent in the Free State and the North West provinces.      </p>
    </div>
  </div>
  <div class="grid__item one-half">
    <p>
      Since our inception in 2012, 661 (12%) of the total number of reports received by Corruption Watch related to allegations of corruption in the schooling environment. After investigation, a substantial 554 (85%) of these reports were confirmed as being cases of corruption.    </p>
    <p>
    ...
    <p>
      The Mxit survey, the first in a series of studies that Corruption Watch plans to conduct into corruption at schools, identified common forms of corruption such as the misuse of school finances and property, learners having to do favours in exchange for marks and nepotism in the appointment of staff.    </p>
    <p>
      <a href="#" target="_blank">
      See the survey here.</a>
    </p>
  </div>
  <div class="grid__item one-half">
    <p>
    ...
    <p>
      It was further identified that the main person behind such corruption, according to 47% of all respondents, was the school principal, with 31% pointing a finger at teachers and 14% claiming that a member of the SGB was the culprit. The Eastern Cape was the province with the most corrupt principals (61%), the Free State (41%) had the worst teachers and the Northern Cape (33%), the most corrupt SGB members.    </p>
    <p>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-whole text--center">
    <h1 id="section--schools_for_sale">
      Are our schools for sale?    </h1>
    <img src="/themes/corruption-watch/color-schemes/grey/img/schools_for_sale.png" alt="" />
    <h2 class="highlight">
      Four problem areas in public schools    </h2>
  </div>
  <div class="grid__item one-quarter">
    <h5>
      Embezzlement of funds    </h5>
  </div>
  <div class="grid__item one-quarter">
    <h5>
      Corruption in procurement    </h5>
  </div>
  <div class="grid__item one-quarter">
    <h5>
      School Governing Body maladministration    </h5>
  </div>
  <div class="grid__item one-quarter">
    <h5>
      Corruption in employment    </h5>
  </div>
  <div class="grid__item one-quarter">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-01.png" alt="" />
    <p>
      Principals are the main wrongdoers and often pay for projects that don’t materialise.    </p>
  </div>
  <div class="grid__item one-quarter">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-02.png" alt="" />
    <p>
      Contracts are given out to family or friends of the Principal or School Governing Body members.    </p>
  </div>
  <div class="grid__item one-quarter">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-03.png" alt="" />
    <p>
      School Governing Bodies do not make financial statements available to parents, either because they do not exist or because the Body refuses to provide this information.    </p>
  </div>
  <div class="grid__item one-quarter">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-04.png" alt="" />
    <p>
      Teachers draw salaries when they are repeatedly absent from work without explanation and are sometimes engaged in full-time remunerative work outside of the school without permission from relevant authorities.    </p>
  </div>
  </div>
<div class="section ar__wrapper grid">
  <a href="#top" class="link--toTop">Back to top</a>
  ...
  <h2>
    ...
    <img src="/themes/corruption-watch/color-schemes/grey/img/corruption_fighters.png" alt="" />
    <p>
    </p>
  </div>
  <div class="grid__item one-half">
  ...
  <div class="grid__item one-half text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/reporting_methods.png" alt="" />
  </div>
  </div>
<a href="#top" class="link--toTop">
Back to top</a>
<div class="section ar__wrapper--white grid">
  <div class="grid__item two-thirds">
    <h1 id="section--school_corruption">
      School corruption    </h1>
    <h2 class="highlight">
      Hot spots    </h2>
    <p class="lead">
      Financial mismanagement, theft of goods and corruption in procurement were the top types of corruption reported in 2013.    </p>
  </div>
  <div class="grid__item one-third text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_hotspots.png" alt="" />
  </div>
  <div class="grid__item one-whole bkg-img bkg-img--3 text--center">
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_hotspots--graph.png" alt="" />
    <p>
    </p>
  </div>
  </div>
<div class="section ar__wrapper grid">
  ...
  <blockquote class="grid__item three-quarters">
    <p>
      What raised our suspicions was the fact that the same person [Ngwenya] was elected repeatedly as chairperson of the SGB. There is protocol that must be followed when choosing members of the SGB and the principal. All parents of learners are eligible for election as a member of the SGB.    </p>
    <p>
      We decided at the last election that we did not want him [Ngwenya] back because he did not qualify to be a member of the SGB. We needed a new person with ideas and innovative thinking for the benefit of the school. Unfortunately though, he was elected once again even though he did not qualify.    </p>
    <p>
  ...
  <img src="/themes/corruption-watch/color-schemes/grey/img/sibongile.jpg" alt="Sibongile Mtuki" class="grid__item one-quarter" />
  </div>
<div class="section ar__wrapper grid">
  <h2 class="grid__item one-whole">
    Finding financial deceipt at Thubelihle  </h2>
  <div class="grid__item one-half">
    <p>
      In February 2013, Corruption Watch received a complaint from a group of teachers at Thubelihle Intermediate School in White City, Soweto. It was alleged that the principal, Nonzwakazi Usiba and former chairperson of the School Governing Body (SGB), Isaac Ngwenya, were tangled in corrupt activities. It was suspected that Usiba and Ngwenya were involved in the misuse of school funds.    </p>
    <p>
      After investigation, Corruption Watch found mass evidence of fraud in the school’s finances. We commissioned an independent auditing firm to assess our findings. The auditors confirmed that corruption was evident and that Usiba and Ngwenya were directly implicated in the wrongdoings, which included:    </p>
    <ul>
      <li>
      ...
      <li>
        10 school cheques totalling R41 059.30 were made out to Ngwenya and no invoices corresponded with the payment.      </li>
    </ul>
  </div>
  <div class="grid__item one-half">
    <ul>
      <li>
        Fake invoices were created for unknown individuals. For example, the school paid an amount of R48 064.74 to one individual against an invoice from Solly’s Packaging and Stationery Distributors, supposedly for calculators, pens and other stationery. It was unclear whether the stationery detailed in the fake invoice was ever delivered to the school and Solly’s Packaging told the forensic auditors that the invoice was not theirs.      </li>
    </ul>
    <p>
    ...
    <p>
      The principal attempted to sidestep disciplinary processes by resigning with immediate effect. However, he was not let off the hook so easily. In this case, the GED forced him to remain in his post, though under suspension, until the investigation is complete.    </p>
  </div>
  </div>
<a href="#top" class="link--toTop">
Back to top</a>
<div class="section ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    <h1 id="section--corruption_reporters">
      Teachers and parents become corruption reporters    </h1>
    <h2>
      Determined to pull off the price tag on the schooling system    </h2>
  </div>
  <div class="grid__item one-half">
    <h5>
  ...
  <div class="grid__item one-half">
    <h5>
    ‘Sad parent’ making a difference</h5>
    <p>
  ...
  <div class="grid__item one-half text--center">
    <h3>
    Pull off the price tag!</h3>
    <img src="/themes/corruption-watch/color-schemes/grey/img/price_tag.png" alt="" />
  </div>
  </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    <h2 class="lowlight">
      Intervention in the Eastern Cape    </h2>
    <h3>
      Flagging the dire state of Macosa    </h3>
    <p>
    ...
    <p>
      We were alerted to Macosa’s dire situation following a tip-off from a concerned citizen who viewed the lack of infrastructure at the school as a red flag for corruption. After investigation, it was established that the situation at Macosa was not one of outright corruption but rather of mismanagement, incompetence, lack of accountability and transparency as well as a failure to transfer funds.    </p>
  </div>
  <div class="grid__item one-half">
    <p>
      Macosa, for example, accommodates almost 500 pupils from poverty stricken communities. According to the principal, the school had not received furniture from the Department of Education since 1990 when she first started teaching there. What furniture remained was 23 years old and falling apart. Learners sat on concrete bricks and make-shift broken chairs, desks were falling apart, there were no proper toilets and the school buildings needed a fresh coat of paint.    </p>
    <p>
      In a letter written to the Eastern Cape Department of Education in November 2013, the principal noted: <em>
    ...
    <p>
      These kinds of cases could involve the waste of public money or resources and as such, are a concern for Corruption Watch.    </p>
  </div>
  <hr />
  <div class="grid__item one-half">
    <h2 class="lowlight">
  ...
  <div class="grid__item one-half">
    <p>
      The aftermath of the corruption uncovered at the Port Elizabeth school was unacceptable. Pupils were fed for one week before the ‘supplier’, who is now R23 000 richer, quit. The corruption fighter, who stood out from an accepting crowd by reporting the incident to Corruption Watch, told of how the principal was buying food from the supermarket because of the lack of supplies at the school.    </p>
    <p>
      Another Eastern Cape tip-off pointed to money being used for a principal’s personal needs. <em>
      “Signatories sign cheques for the principal to build her house. There are no chairs and desks and learners are forced to use bricks as chairs. Learners are not given food everyday because the principal buys a 12.5kg mieliemeel and one container of soup for 600 learners,”</em>
 reported this corruption fighter.    </p>
    <p>
...
<div class="section ar__wrapper grid ar__wrapper--blockquote">
  ...
  <figure class="grid__item one-quarter">
    <img src="/themes/corruption-watch/color-schemes/grey/img/mavuso.jpg" alt="Mavuso Msimang" />
  </figure>
  </div>
<div class="section ar__wrapper grid">
</div>
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main"  id="section--government_ngos">
    Government and NGOS  </h1>
    </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    <h1 class="highlight" id="section--mvula_trust_scandal">
      Exposed! Mvula Trust scandal    </h1>
    <div class="text--center">
      <img src="/themes/corruption-watch/color-schemes/grey/img/megaphone--red.png" alt="" class="three-quarters" />
    </div>
  </div>
  <div class="grid__item one-half">
    <h2>
      Behind the scenes of breaking the silence    </h2>
    <p>
      In 2012, Corruption Watch received reports that rural development NGO, Mvula Trust had obtained a government tender worth R30-million, irregularly. A four-month investigation began and in early 2013, we exposed Mvula Trust for fronting by subcontracting a significant part of the contract to a third party, Ubuntu Sima.    </p>
    <p>
    ...
    <p>
      In May 2013, Corruption Watch made submissions to the inquiry based on the findings of our investigation. We had found that the arrangement between the Mvula Trust and the third party was not disclosed in the initial bidding documents as required. To boot, a number of questionable links relating to conflicts of interest between the Trust and Ubuntu Sima were uncovered.    </p>
    <p>
  ...
  <div class="grid__item one-half">
    <p>
      The email was meant to have been sent from the municipality to another company, Sinqobile &amp; Jose, but was sent to Seletech’s accounting officer by mistake. A short while before receiving the email, Seletech had received an order as usual from JS Moroka, but this time with an added instruction to deliver the vials not to the municipality – as it had done numerous times before – but to the offices of Sinqobile &amp; Jose. It was asked to give the package to a man called “Sipho”.    </p>
    <p>
      On investigation into the unbalanced invoicing equation, Corruption Watch discovered that the procurement officer at the municipality who signed off on the   R24 000 payment to Sinqobile &amp; Jose was Rabelani Thukwana – who was married to Sipho Thukwana.happens to be the same person to whom Seletech was asked to deliver the set of vials last year and to whom Sinqobile &amp; Jose is registered.    </p>
    <p>
      As a result of Corruption Watch’s investigation, three officials at the municipality were suspended.    </p>
  </div>
  <hr />
  <div class="grid__item one-half">
    <h2 class="lowlight" id="subsection--mpumulanga_health">
      Mpumalanga’s critical health check    </h2>
    <h3>
      Unfit circumcision tender process diagnosed    </h3>
    <p>
      In August 2013, following a corruption fighter’s complaint, Corruption Watch began investigating the Mpumalanga Health Department’s choice to award a multi-million rand tender to circumcise 260 000 boys and men in the province. Earlier in 2013, the department signed a one year-contract with Ebby Bongani Mkhabela, the owner of Mkhago Health Care Services to perform circumcisions at a cost of R700 per person, without advertising the contract.    </p>
  </div>
  <div class="grid__item one-half">
    <p>
      The bottom line of this case was that if all 260 000 circumcisions were completed,  Mkhago Healthcare Service would have been R182-million richer. Our investigation revealed that the public tender process was not followed in the awarding of the contract. By law all contracts over R500 000 must be awarded through a public competitive bidding process.    </p>
    <p>
      In the case of Mkhago, Corruption Watch found that the company presented a business proposal and won the contract without having to go through the required tender process. The investigation also revealed that Mkhabela has been linked to a botched circumcision in 2008!    </p>
    <p>
      Based on our findings, the Department of Health set out to conduct its own forensic investigation into the matter and in the meantime, the contract between the department and Mkhago is suspended.    </p>
  </div>
  <hr />
  <div class="grid__item one-half">
    <h2 class="lowlight">
    ...
    <p>
      Constitutional Court Judge Johan Froneman handed down a unanimous judgment, which found that the decision to award the tender to CPS was constitutionally invalid. As a friend of the court in this case, our 15-minute court appearance played a role in the enunciation of a clear legal standard in determining how irregularities in tender awards should be understood.    </p>
  </div>
  <div class="grid__item one-half">
    <p>
    ...
    <p>
      In the judgment Judge Froneman held that compliance with the requirements of a tender process is crucial and that insistence on compliance serves three purposes:      <ol>
        <li>
    ...
    <p>
      The Court found that SASSA had failed to investigate and confirm CPS’s Black Economic Empowerment credentials before awarding the business. It also found that the second bidders’ notice issued during the tender process was vague and uncertain, and gave rise to procedural unfairness.    </p>
    <p>
 ...
 The Court has ordered the parties to return to court on 11 February 2014 to present evidence as to a “just and equitable” remedy.    </p>
  ...
  <div class="grid__item one-half">
    ...
    <ol>
      <li>
      Prohibiting public officials from conducting business with the State. In our view, a ban on public officials doing business with the State should be extended to include a ban on immediate family members of public officials doing the same.</li>
      <li>
      Restriction of outside remunerative work.</li>
      <li>
...
<div class="section ar__wrapper--white grid">
  <div class="grid__item two-thirds">
    ...
    <p>
      The submission to the Competition Tribunal related to the hearings into the R1.46-billion settlement agreements facing top listed construction firms who rigged bids for, among other large projects, the FIFA 2010 World Cup™ infrastructure projects.    </p>
    <h5>
      In the written submission, Corruption Watch:    </h5>
    <ol>
      <li>
  ...
  <div class="grid__item one-third">
    <div class="Xlight">
    <h3>
    Clarifying the meaning of ‘conflicts of interest’</h3>
    <h5>
    ...
    <p>
      For example:      <ul>
        <li>
        Holding public office as well as private business interests and using your public position to benefit your private interests.</li>
        <li>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--leading_perspective">
    Leading perspective  </h1>
    </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    <h1 class="highlight">
      The need to take our country forward holding our heads high    </h1>
    <p class="lead">
      A South African society that is against corrupt behaviour is not impossible to achieve, says <a href="#bio--david">
      David Lewis, Executive Director of Corruption Watch</a>
. But it needs us to draw the line on where corruption begins and to rally together by speaking out against those who overstep this mark.    </p>
  </div>
  <div class="grid__item one-half">
    <p>
...
.    </p>
    ...
    <img src="/themes/corruption-watch/color-schemes/grey/img/megaphone--white.png" alt="" class="one-quarter float--left" />
    <p>
 ...
 to the Competition Tribunal.  We also appeared in the Constitutional Court and made a major contribution to an important judgement that will make it far more difficult to corrupt tender awards.    </p>
    ...
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-01.png" alt="" class="one-third float--left" />
    <p>
    ...
    <p>
      But very troubling dark spots remain. For people who travel the roads and streets of South Africa, traffic policing can mean corruption.  For traders, corrupt municipal police may well be your everyday experience.    </p>
  </div>
  <div class="grid__item one-half">
    <h5>
      Turning our attention to elections    </h5>
    <img src="/themes/corruption-watch/color-schemes/grey/img/school_corruption--icons-04_alt.png" alt="" class="one-quarter float--left" />
    <p>
      We still have a mountain to climb and there is every indication that 2014 is going to be an even more eventful year.      <ul>
        <li>
        <a href="#subsection--mpumulanga_health">
We are planning a campaign directed at corruption in the healthcare system</a>
.</li>
        <li>
        <a href="#section--your_voice_counts">
We have introduced a new telephone hotline</a>
 to add to our existing platforms for reporting corruption.</li>
        <li>
        We are setting up an online and mobile phone platform that will enable us to build communities of corruption fighters.</li>
      </ul>
    </p>
    <p>
    ...
    <img src="/themes/corruption-watch/color-schemes/grey/img/investigation_alt.png" alt="" class="one-sixth float--left" />
    <p>
      We want our elected representatives to serve the public rather than to see their position as an opportunity for enriching themselves.  What is becoming increasingly clear is that many of our most pressing corruption-related problems stem from powerful elected leaders at all levels of government, who in collaboration with wealthy individuals and business interests, consider themselves above the law.    </p>
    <p>
      Up until now we have concentrated on the conduct of public officials and the private.  It is time to turn our attention to our elected representatives, those who are meant to represent an accountable democracy.    </p>
  </div>
  </div>
<a href="#top" class="link--toTop">
Back to top</a>
<div class="section ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    <h1 id="section--corruption_fighter">
      Profile of a corruption fighter    </h1>
    <p class="lead">
      There is a growing movement of people in South Africa who are concerned about potential corruption in their community. This force of corruption fighters is growing as more and more, people step forward, speak up and speak out.    </p>
    <img src="/themes/corruption-watch/color-schemes/grey/img/corruption_fighter.png" alt="Corruption Fighter" />
  </div>
  </div>
<!--    ============================    -->
<!--      End Leading Perscpective      -->
<!--    ============================    -->
<div class="section ar__wrapper grid">
  <a href="#top" class="link--toTop">Back to top</a>

  <h1 class="grid__item one-whole header--main" id="section--leadership_profile">
    Leadership profile  </h1>
    </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    <p class="lead">
      The nine members of our board guide our mission and vision. It is their responsibility to ensure that Corruption Watch meets its legal requirements, to make sure the organisation is well run and is on a sound financial footing and that all its constituencies are represented.    </p>
  </div>
  <div class="grid__item one-half">
    <a href="bio--archbishop">
    </a>
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Ndungane.jpg" alt="Archbishop Njongonkulu Ndungane" class="float--left one-fifth">
    <h3>
    Archbishop Njongonkulu Ndungane</h3>
    <h4>
    Former Anglican Archbishop of Cape Town</h4>
    <p>
...
, the executive director of the Historic Schools Restoration Project, the chairman of the Council of the University of Cape Town, and a trustee of The Sunfoil Educational Trust, recently formed by Cricket South Africa.    </p>
    ...
    <p>
      Before being appointed as Archbishop of Cape Town on 1 September 1996, he was principal of St Bede’s Theological College in Mthatha; executive officer of the Anglican Church of Southern Africa and bishop of Kimberley and Kuruman.    </p>
    <p>
  ...
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Hassim.jpg" alt="Adila Hassim" class="float--left one-fifth">
    <h3>
    Adila Hassim</h3>
    <h4>
    Advocate and director of litigation and legal services at the Aids Law Project</h4>
    <p>
      Adila Hassim is a founding member of Corruption Watch. She’s an advocate and director of litigation and legal services at Section27.    </p>
    <p>
 ...
 and an honorary member of the TAC.    </p>
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Brown.jpg" alt="Alice Brown" class="float--left one-fifth">
    <h3>
    Alice Brown</h3>
    <h4>
    International human rights advocate</h4>
    <p>
      Alice Brown is an international human rights advocate and an expert on the use of the law for the public good Her distinguished career has focused on civil rights litigation and social justice philanthropy, with an emphasis on institution-building for non-governmental organisations.    </p>
    <p>
      She served nearly two decades of leadership at the Ford Foundation, as a human rights programme officer in its New York headquarters and as a programme officer, deputy representative and then representative for the foundation's Southern African office, based in Johannesburg. During this time, she engaged in innovative grant making to support visionaries working on crucial global, regional and national issues in the areas of human rights, social justice, constitutionalism and reconciliation, supervising funding programs with cumulative grant making of well over $US100million.    </p>
    <p>
      Earlier in her career, she spent five years at the NAACP Legal Defense and Educational Fund, where her work and publications addressed legal aspects of housing conditions and environmental degradation in African American communities.    </p>
    <p>
      Brown is a member of the US Council on Foreign Relations, and also a member of the advisory committees of the Wits Justice Project and of Lawyers Against Abuse. She is a former board member of Human Rights Watch, the Lawyers’ Committee for Human Rights and the South Africa - United States Fulbright Commission, and an alumna of Common Purpose South Africa. Brown graduated with a BA in History from Dartmouth College, and is a graduate of the New York University School of Law, where she was idd an Arthur Garfield Hays Civil Liberties Fellow based on her commitment to civil rights and public interest law. She has been a visiting adjunct professor at the University of the Witwatersrand School of Law, a fellow of the Harvard Law School Human Rights Program, and a visiting fellow at the Woodrow Wilson School at Princeton University.    </p>
    <p>
  ...
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Lewis.jpg" alt="David Lewis" class="float--left one-fifth">
    <h3 id="bio--david">
    David Lewis</h3>
    <h4>
    Former Competition Tribunal chairperson</h4>
    <p>
    ...
    <p>
      From 1990, Lewis directed UCT’s Development Policy Research Unit, which specialises in trade and industrial policy. Between 1994 and 1996 he was special adviser to the minister of labour and co-chaired the Presidential Commission on Labour Market Policy. Later he was a member of the task team advising the minister of trade and industry on the development of competition policy.    </p>
    <p>
      He participated in the drafting of the Competition Act, and was a member of the Competition Board from January 1998, chairing the board from January to August 1999. With the promulgation of the Competition Act in September 1999, Lewis was appointed chairperson of the Competition Tribunal.    </p>
    <p>
      He was a founder member of the International Competition Network, a member of its Steering Group from 2001 until 2009 and chairman of the Steering Group in 2008-9. Lewis was deputy chairman of the Industrial Development Corporation’s board from 2002 to 2008 and chairman of its human resources committee. In 2009 Lewis was appointed an extraordinary professor at the Gordon Institute of Business Science. A year later, UCT awarded him an honorary doctorate in economic sciences.    </p>
    <p>
      ...
      Thieves at the Dinner Table: Enforcing the Competition Act</a>
 – a Personal Account was published in 2012.    </p>
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Mashinini.jpg" alt="Emma Mashinini" class="float--left one-fifth">
    <h3>
    Emma Mashinini</h3>
    <h4>
    Former general secretary of the Commercial, Catering and Allied Workers’ Union of South Africa</h4>
    <p>
      Emma Mashinini became the first general secretary of the Commercial, Catering and Allied Workers’ Union of South Africa (CCAWUSA) in 1975. She was instrumental in growing the union substantially in the following years. Mashinini was arrested in 1981 under Section 6 of the Terrorism Act and held in solitary confinement at Pretoria Central Prison for six months.    </p>
    <p>
      In 1985, through her role in CCAWUSA, she was involved in the formation of the <a href="http://www.cosatu.org.za/" target="_blank">
      Congress of South African Trade Unions (Cosatu)</a>
. In 1986 she was appointed head of the Department of Justice and Reconciliation later working as deputy chairperson of the National Manpower Commission and then as the <a href="http://www.dla.gov.za/services/commission-on-restitution-of-land-rights" target="_blank">
commissioner for land restitution</a>
. In 2007 Mashinini <a href="http://www.thepresidency.gov.za/pebble.asp?relid=7935" target="_blank">
became a Companion of the Order of Luthuli in Bronze</a>
 for her "outstanding contribution in building the trade union movement, her resilience under apartheid harassment and detention, in the cause for a non-sexist, non-racial, just and democratic South Africa".    </p>
    <p>
      Her autobiography is titled <a href="http://www.kalahari.com/Books/Strikes-Have-Followed-Me-All-My-Life_p_44917299" target="_blank">
      Strikes Have Followed Me All My Life</a>
.    </p>
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/ORegan.jpg" alt="Kate O’Regan" class="float--left one-fifth">
    <h3>
    Kate O’Regan</h3>
    <h4>
    Mediator and former Constitutional Court judge</h4>
    <p>
      Kate O’Regan is a former Constitutional Court judge, appointed in 1994 during the transitional period to democracy. She was the youngest judge, and is one of only two women to be appointed. Her 15-year term ended in 2009.    </p>
    <p>
      She was the inaugural chairperson of the United Nations Internal Justice Council from 2008 – 2012 and she is currently president of the International Monetary Fund Administrative Tribunal, a member of the World Bank Sanctions Board, an ad hoc judge of the Namibian Supreme Court, a visiting professor at Oxford University and an honorary professor at UCT.    </p>
    <p>
...
, and he is chairperson of the iSimangaliso Wetland Park, a world heritage site.    </p>
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Pikoli.jpg" alt="Vusi Pikoli" class="float--left one-fifth">
    <h3>
    Vusi Pikoli</h3>
    <h4>
    ...
    <p>
      From 1999 to 2005 he was director-general in the same department, and was then appointed to head up the <a href="http://www.npa.gov.za/" target="_blank">
      National Prosecuting Authority</a>
, a position he held until 2008.    </p>
    <p>
      Pikoli’s recently published memoir, <em>
      My Second Initiation</em>
, details this journey from his first initiation as a young man in the Eastern Cape, to his second as a top-ranking government official.    </p>
    <p>
      Pikoli is a former trustee of the Constitutional Court Trust, and a founding member of the International Association of Anti-Corruption Authorities. Until February 2012 he was a director of the forensic investigation division at SizweNtsalubaGobodo. He also headed up the forensics department at Gobodo Inc. He is currently an independent director on the board of Cricket South Africa, where he chairs the social and ethics committee. He also heads his own forensic company, Vee Pee Forensic Consultants.    </p>
    <p>
      ...
      he and Kate O’Regan were appointed as co-commissioners of a commission of inquiry</a>
 into allegation of police inefficiency in Khayelitsha in the Western Cape. The commission is due to start public hearings towards the end of January 2014.    </p>
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Dubula.jpg" alt="Vuyiseka Dubula" class="float--left one-fifth">
    <h3>
    Vuyiseka Dubula</h3>
    <h4>
    General secretary of the Treatment Action Campaign</h4>
    <p>
      Vuyiseka Dubula, the general secretary of the Treatment Action Campaign (TAC), has been a role model for women living with HIV since she joined the organisation in 2002 as a literacy co-ordinator.    </p>
    <p>
      She later became provincial co-ordinator for the Western Cape and then national co-ordinator before taking up the duties of general secretary in 2008.    </p>
    <p>
      Dubula has been chairperson of the board of the Aids Law Project since 2008 and is currently a board member of gender rights organisation Sonke Gender Justice. She is the former chairperson of the board of Corruption Watch.    </p>
    <p>
  ...
  <hr />
    <img src="/themes/corruption-watch/color-schemes/grey/img/board/Vavi.jpg" alt="Zwelinzima Vavi" class="float--left one-fifth">
    <h3>
    Zwelinzima Vavi</h3>
    <h4>
    General secretary of the Congress of South African Trade Unions <em>
(suspended)</em>
</h4>
    <p>
      Zwelinzima Vavi joined the Congress of South African Students a year after its official launch in 1979, but his activism for the struggles of the working class began in 1984 when he joined Vaal Reefs Gold Mine and became a shop steward – in 1987 he was dismissed following a 21-day strike.    </p>
    <p>
      Vavi joined the National Union of Mineworkers as an organiser in the same year. In 1988, he became Cosatu’s regional secretary for the Western Transvaal (an area covering the North West, Vaal Triangle and northern parts of the Free State) and in 1992 took up the position of national organising secretary. He served as deputy general secretary from 1993 to 1999 and was then appointed as general secretary.    </p>
    <p>
      In 2002 Vavi was made a member of the International Labour Organisation’s World Commission on the Social Dimension of Globalisation. Four years later he was elected to the International Trade Union Confederation’s executive board and steering committee, and in 2007 he was appointed a member of the Local Organising Committee Board for the 2010 Fifa World Cup as well as its audit committee.    </p>
    <p>
      He is presently on suspension as the general secretary of Cosatu, an organisation to which he has devoted three decades of service.    </p>
  </div>
  </div>
<!--    ==========================    -->
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--funders">
    Funders &amp; supporters  </h1>
    </div>
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    <h3>
    Andrew Roberts Memorial Trust</h3>
    <p>
      The Andrew Roberts Memorial Fund is a family charity that supports and further develops social justice projects in South Africa. The fund was started by Dr Mary Ellis in remembrance of her father, Dr Andrew Roberts.    </p>
    <h3>
    Atlantic Philanthropies</h3>
    <p>
      The Atlantic Philanthropies are dedicated to bringing about a lasting change in the lives of the disadvantaged and vulnerable people. Atlantic is a limited life foundation focused on four critical social issues, idly ageing, children and youth, population health as well as reconciliation and human rights. Programmes funded by the Foundation operate in Australia, Bermuda, Northern Ireland, the Republic of Ireland, South Africa, the United States and Vietnam.    </p>
    <h3>
    Aveng Group</h3>
    <p>
    ...
    <h3>
    Bertha Foundation</h3>
    <p>
      The Bertha Foundation is dedicated to supporting judicial and non-judicial justice initiatives to protect basic human rights. It is also involved in social movements, serving the public interest, improving the quality of lives and supporting new generations of activists.    </p>
    <h3>
    Claude Leon Foundation</h3>
    <p>
      The Claude Leon Foundation is a charitable trust established in 1963 and works in the fields of education and human rights. The foundation supports non-governmental organisations that are at the forefront of defending democracy and better education in South Africa, and promoting good governance and effective service delivery.    </p>
    <h3>
    Ford Foundation </h3>
    <p>
      The Ford Foundation is an independent non-profit, non-governmental organisation which supports visionary leaders and organisations on the frontlines of social change. The Foundation encourages initiatives by those living and working closest to where problems are located, promotes collaboration among the non-profit, government and business sectors, and strives to ensure participation by men and women from diverse communities and all levels of society.    </p>
    <h3>
  ...
  <div class="grid__item one-half">
    ...
    Hivos</h3>
    <p>
      The Human Institute for Cooperation with Developing Countries (Hivos) is an international development organisation guided by humanist values. Together with local civil society organisations in developing countries, Hivos wants to contribute to a free, fair and sustainable world.    </p>
    <h3>
    Millennium Trust</h3>
    <p>
    ...
    Raith Foundation </h3>
    <p>
      The Raith Foundation aims to further a just and fair society in which the State and the private sector are both held accountable for their actions.    </p>
    <h3>
    SAB Limited </h3>
    <p>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--contact">
    Contact Corruption Watch  </h1>
    </div>
<!--  ===================================================  =             End Annual Report Content           =  ===================================================-->
