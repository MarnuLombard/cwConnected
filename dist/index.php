...
<div class="section ar__wrapper grid" id="section--top">
  ...
  <div class="ar__nav grid__item">
    <span class="nav-link__wrapper">
      ...
      Corruption Fighters Speak Up</a>
        ...
        Who are Our Corruption Fighters?</a>
        <a href="#section--how_worried" class="nav-link--sub">
        How Worried Should South Africans Be?</a>
        <a href="#section--foreword" class="nav-link--sub">
        Foreword by the Chair</a>
        <a href="#section--corruption_fighter" class="nav-link--sub">
        Profile of a Corruption Fighter</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--what_is_corruption_watch" class="nav-link">
  ...
  <div class="ar__nav grid__item">
    <span class="nav-link__wrapper">
      ...
      On Our Watch</a>
        ...
        Corruption Hot Spots Revealed</a>
    </span>
    <span class="nav-link__wrapper">
      <a href="#section--schools" class="nav-link">
      Corruption in Schools</a>
        <a href="#section--claiming_back_future" class="nav-link--sub">
        Claiming Back Our Children's Future</a>
  ...
  <div class="ar__nav grid__item">
    <span class="nav-link__wrapper">
      <a href="#section--corruption_exposed" class="nav-link">
      Corruption Exposed</a>
        <a href="#section--mvula_trust_scandal" class="nav-link--sub">
        R30m Mvula Trust Scandal</a>
    ...
    <span class="nav-link__wrapper">
      <a href="#section--our_board" class="nav-link">
      Our Board</a>
    </span>
    <span class="nav-link__wrapper">
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-whole text--center">
    ...
    <img src="img/africa.png" alt="The rank of South Africa's corruption performance as relating to other countries"  class="maxImg" />
  </div>
</div>

<div class="section ar__wrapper grid">
 <div class="grid__item one-half text--center">
    <table summary="The rank of South Africa's corruptrion performance as relating to other countries" class="dataTable" cellpadding="1" cellspacing="2px" >
      <tr>
        <th>Out of 177 countries</th>
        <th>Country Score</th>
        <th>Out of 100</th>
      </tr>
      <tr>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-half">
    ...
    <table summary="The rank of South Africa's corruptrion performance as relating to the BRICS nations" class="dataTable text--center" cellpadding="1" cellspacing="2px" >
      <tr>
        <th>Out of 177 countries</th>
        <th>Country Score</th>
        <th>Out of 100</th>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-half text--center">
    <table summary="The rank of South Africa's corruptrion performance as relating to the G20 nations" class="dataTable" cellpadding="1" cellspacing="2px" >
      <tr>
        <th>Out of 177 countries</th>
        <th>Country Score</th>
        <th>Out of 100</th>
...
<div class="section ar__wrapper grid bkg-img bkg-img--1">
  <div class="grid__item one-third">
    ...
    <p>
      People across the country are speaking out against corruption in their communities. Every one of these <a href="#section--corruption_fighter">
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-half">
  <img src="/img/board/Ndungane.jpg" alt="Archbishop Njongonkulu Ndungane" class="float--left two-fifths">
    <p>
...
<div class="section ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    ...
    <p class="lead">
      There is a growing force of corruption fighters in South Africa as people step forward and speak out. Join the movement by making your voice heard.
    </p>
    <img src="/img/corruption_fighter.png" class="one-third" alt="Corruption Fighter" />
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <h1 class="grid__item one-whole header--main" id="section--what_is_corruption_watch">
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item two-thirds">
    <h1 class="" id="section--your_voice_counts">
    Your voices count
    </h1>
    <a href="#top" class="link--toTop">Back to top</a>
   <h3>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    <h1 id="section--corruption_reported">
      Corruption reported
    </h1>
  </div>
  ...
  <div class="grid__item one-half text--center">
    <h3>
      ...
      <img src="/img/corruption_reported.png" alt="Corruption confirmed in 58% of reports received" />
  </div>
  <div class="grid__item one-half text--center">
    <h3>
      On average <span class="highlight">6</span> reports received per day
    </h3>
    <img src="/img/calendar.png" alt="6 reports received per day" />
  </div>
</div>

<div class="section ar__wrapper--white grid">
  <div class="grid__item one-whole text--center">
    <img src="/img/total_reports.png" alt="" class="center" />
  </div>
</div>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-whole text--center">
    ...
    <p class="lead">
      The top four sectors from which we have received corruption reports in 2013 are:
    </p>
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-third text--center">
    <img src="/img/schools_piechart.png" class="maxImg" alt="" />
  </div>
...
<div class="section ar__wrapper--white grid">
  <div class="grid__item two-thirds">
    ...
    <p class="lead">
      Top types of corruption reported in 2013 were financial mismanagement, theft of goods and corruption in procurement.
    </p>
  </div>
  <div class="grid__item one-third text--center">
...
<div class="section ar__wrapper grid ar__wrapper--blockquote">
  <blockquote class="grid__item three-quarters">
    <p>We have reason to be proud of our achievements over the past twenty years as a free and democratic country. Corruption in public places, if not exposed and vigorously opposed, will certainly limit economic development, deepen poverty and lead to unmanageable social instability.</p>
      <span class="cite">
        <a href="#bio--mavuso_msimang">
        Mavuso Msimang</a>, Board Member of Corruption Watch
      </span>
  </blockquote>
  <div class="figure grid__item one-quarter">
    <img src="/img/mavuso.jpg" class="three" alt="Mavuso Msimang" />
  </div>
</div>
...
<div class="section ar__wrapper grid">
  <h1 class="grid__item one-whole header--main"  id="section--corruption_exposed">
    Corruption Exposed
  </h1>
  <a href="#top" class="link--toTop">Back to top</a>
</div>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    <h1 id="section--mvula_trust_scandal">
      R30m Mvula Trust Scandal</h1>
    <div class="text--center">
      <img src="/img/mvula.jpg" alt="R30m Mvula Trust Scandal" class="maxImg" />
    </div>
  </div>
  <div class="grid__item one-half">
    <h2>
...
<div class="section ar__wrapper--white grid">
  ...
  <div class="grid__item one-third">
    ...
    <p>
      ...
      Read more about what South African law says about conflict of interest.</a>
    </p>
  </div>
  </div>
  </div>
<!--    =========================       -->
<!--     End Corruption exposed         -->
<!--    =========================       -->
...
<div class="section ar__wrapper grid">
  <h1 class="grid__item one-whole header--main" id="section--2014_focus">
    Our Focus in 2014
  </h1>
  <a href="#top" class="link--toTop">Back to top</a>
</div>
...
<div class="section ar__wrapper grid">
  <h1 class="grid__item one-whole header--main" id="section--our_board">
    Our Board
  </h1>
  <a href="#top" class="link--toTop">Back to top</a>
</div>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-whole">
    <p class="lead">
      The eleven members of our board guide our mission and vision. It is their responsibility to ensure that Corruption Watch meets its legal requirements, to make sure the organisation is well run and is on a sound financial footing and that all its constituencies are represented.    </p>
    </div>
</div>
...
<div class="section ar__wrapper grid">
  <div class="grid__item one-half">
    <img src="img/board/Ndungane.jpg" class="float--left one-fifth" alt="Archbishop Njongonkulu Ndungane" />
    <h3 id="bio--archbishop">Archbishop Njongonkulu Ndungane</h3>
    <h4>Former Anglican Archbishop of Cape Town</h4>
    <p>
      Archbishop Njongonkulu Ndungane is the former Anglican archbishop of Cape Town and a recipient of the Order of the Grand Counsellor of the Baobab in silver. He retired in 2007 from religious service but is still active in society. His current positions include president and founder of African Monitor, the executive director of the Historic Schools Restoration Project, the chairman of the Council of the University of Cape Town, and he is a trustee of The Sunfoil Educational Trust recently formed by Cricket South Africa. Ndungane is known for his commitment to social issues, such as poverty alleviation, the Millennium Development Goals, and the transformation of historically significant and under-resourced schools in South Africa into centres of cultural and educational excellence.
    </p>

    <img src="img/board/Hassim.jpg" class="float--left one-fifth" alt="Adila Hassim" />
    <h3 id="bio--adila_hassim">Adila Hassim</h3>
    <h4>Advocate and director of litigation and legal services at the Aids Law Project</h4>
    <p>
      Adila Hassim is a founding member of Corruption Watch. She is an advocate and director of litigation and legal services at Section27. Hassim earned a BA and LLB from the University of Natal, and later an LLM from the St Louis University School of Law in the United States as well as a JSD, or doctorate in law, cum laude from the University of Notre Dame Law School. She is a member of the Johannesburg Bar and was admitted as an advocate of the High Court of South Africa in 2003. Hassim has published in law journals, health journals and newspapers and has co-authored books on human rights and health law. She is a member of the National Association of Democratic Lawyers and an honorary member of the TAC.
    </p>

    <img src="img/board/Brown.jpg" class="float--left one-fifth" alt="Alice Brown" />
  ...
  <div class="grid__item one-half">
    <img src="img/board/Metcalfe.jpg" class="float--left one-fifth" alt="Mary Metcalfe" />
    ...
    <h3 id="bio--vuyiseka_dubula">Vuyiseka Dubula</h3>
    <h4>General secretary of the Treatment Action Campaign</h4>
    <p>
      Vuyiseka Dubula, the general secretary of the Treatment Action Campaign (TAC), has been a role model for women living with HIV since she joined the organisation in 2002 as a literacy co-ordinator. Dubula has been chairperson of the board of the Aids Law Project since 2008 and is currently a board member of gender rights organisation, Sonke Gender Justice. She is the former chairperson of the board of Corruption Watch. She holds a BA in health sciences and social services from Unisa, with a specialisation in applied psychology and a postgraduate diploma and an MPhil in HIV/Aids management from the University of Stellenbosch. Her work on behalf of people living with HIV has garnered her two prestigious international awards - the Letten Foundation Courageous Leadership Award in 2004 and, in 2010, the Lloyd Foundation Leadership Award, which recognises, develops and empowers leadership in HIV/Aids advocacy.
    </p>

    <img src="img/board/Vavi.jpg" class="float--left one-fifth" alt="Zwelinzima Vavi" />
...
<div class="section ar__wrapper grid">
  ...
  <div class="grid__item one-half">
    ...
    <p class="lead">
      Office: <strong>011 447 1472 </strong><br />
      Email: <strong><a href="mailto:info@corruptionwatch.org.za">info@corruptionwatch.org.za</a> </strong><br />
      Physical address: <strong>191 Jan Smuts, Standard Bank Building, 4th floor, Johannesburg.</strong>
      Postal address: <strong>PO Box 113 Parklands 2121</strong>
    </p>
  </div>
  ...
  <div class="grid__item one-half">
    <h2 class="">Media Liason</h2>
    <p class="lead">
      Patience Mkosana <br />
      Office: 011 447 1472 <br />
      Fax:  011 447 2696 <br />
      Cell: 072 992 8380 <br />
      <a href="mailto:patiencem@corruptionwatch.org.za">patiencem@corruptionwatch.org.za</a>
    </p>
  </div>
</div>
<!--  ===================================================
